...
def evaluate_syntactic(output, gold, predicted, kind, task_name="syntactic", is_text=False):
...
def main(argv):
    ...
    evaluate_syntactic(args.output, args.gold, args.predicted, args.kind, args.task_name, args.is_text)
