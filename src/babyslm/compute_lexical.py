...
def evaluate_lexical(output, gold, predicted, kind, task_name="lexical", is_text=False):
    ...
    all_trials, by_pair, by_frequency, by_length = evaluate(gold_file, submission_file, is_text=is_text)
...
def main(argv):
    ...
    evaluate_lexical(args.output, args.gold, args.predicted, args.kind, args.task_name, args.is_text)
